...
// This is done because it's conflicting with CBasePanel in vgui_basepanel.h, which is weird because portalcoop didn't have this problem - Wonderland_War
#define CBasePanel CBasePanelSimplified
